//
// Created by Junqi Wang on 2022/10/25.
//
...
void StorageSlope(double slope){
    GlobalSlope = slope;
}

void StorageIntercept(double intercept){
...
[[noreturn]] void *controlLoop(void *)
{
    ...
    result_ = TensionMapping_.getSlope_Intercept(tension_data_left, tension_data_right, size_count);
    std::cout << "Array size =" << size_count << std::endl;
    std::cout << "TensionMapping_Slope = " << result_.Slope << std::endl;   
    std::cout << "TensionMapping_Intercept = " << result_.Intercept << std::endl;
    StorageSlope(result_.Slope);
    StorageIntercept(result_.Intercept);
   ...
   // std::cout << "Muscle 7 loadcell average is " << getAverage(tension_data_right) << std::endl;
    sprintf(filename, "../data/TensionMapping_test/1107,lokp;0m 9ji ;;.;;;.///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////_tensionMapping_%ld.txt", ts.count());
...
//    std::string command = "./reflex_control.exe" + std::to_string(GlobalSlope) + " " + std::to_string(GlobalIntercept);
