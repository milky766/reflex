...
{
    double natural_length_slope, natural_length_intercept,natural_length;
...
SpinalCord::Sensor_info_model SpinalCord::get_agonist_sensor_info_model()
{
    return {.muscle_len_model = agonist_len_model_, .muscle_v_model = agonist_v_model_,
            .muscle_filtered_v_model = filtered_agonist_v_model_, .muscle_tension_model = agonist_tension_,
            };
}
